...
class RolloutConfig(BaseConfig):
    ...
    # When true, the trainer overrides the rollout-generated responses with the dataset's
    # gold answer (reward_model.ground_truth) right after generate_sequences(). This is the
    # plain-SFT mode: combined with self_distillation.alpha=0 + teacher_regularization=gold,
    # the SDPO/SDFT loss reduces to NLL on gold tokens. The eval-only path is unaffected.
    use_gold_response: bool = False
