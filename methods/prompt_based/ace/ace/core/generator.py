...
class Generator:
    ...
    def __init__(self, api_client, api_provider, model: str, max_tokens: int = 4096,
                 enable_thinking: bool = True, extra_body: dict | None = None):
        """
        ...
        Args:
            ...
            enable_thinking: If False, inject provider-specific extra_body to
                disable qwen3 reasoning/thinking mode on every LLM call.
        """
